...
+ [2. JAR (утилита jar)](#-2-jar-(утилита-jar))
  + [2.1. Создание JAR (-c --create)](#-2.1.-создание-jar--c---create)
  + [2.2. Просмотр содержимого JAR (-t --list)](#-2.2.-просмотр-содержимого-jar--t---list)
  + [2.3. Запуск, исполнение JAR](#-2.3.-запуск-исполнение-jar)
